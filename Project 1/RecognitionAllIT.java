...
public class RecognitionAllIT {
    ...
    public RecognitionAllIT(File snap) throws Exception {
        this.snap = snap;
    ...
    @Test
    public void testAllInTheRightestWayPossible() throws IOException, ParserConfigurationException, SAXException {
        logger.info("####### RUNNING: TEST ALL ######");
        ...
        String snapName = this.snap.getName();
